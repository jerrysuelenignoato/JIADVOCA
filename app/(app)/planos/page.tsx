...
const PLANOS = [
  {
    ...
    preco: "R$97",
    periodo: "/mês",
    desc: "60 roteiros de carrossel e reels por mês",
    recursos: [
      "60 roteiros por mês",
    ...
    nao: ["Biblioteca e Kanban", "Calendário editorial", "Carrossel completo com imagem"],
    cor: "border-border",
    badge: null,
  },
  {
    ...
    preco: "R$127",
    periodo: "/mês",
    desc: "Tudo do Roteiro + carrossel completo com imagem real",
    recursos: [
      "60 gerações por mês",
      "Roteiro de carrossel",
      "Roteiro de reels",
