...
const PLANOS = [
  {
    ...
    preco: "R$97",
    periodo: "/mês",
    desc: "Para quem quer criar roteiros de Reels todo mês",
    recursos: [
      "60 roteiros por mês",
      "Scripts completos para Reels",
      "Biblioteca e Kanban",
      "Calendário editorial",
      "Suporte por email",
    ],
    nao: ["Carrosséis prontos"],
    cor: "border-border",
    badge: null,
  },
  {
    ...
    preco: "R$127",
    periodo: "/mês",
    desc: "Reels e carrosséis prontos com imagem real",
    recursos: [
      "60 gerações por mês",
      "Scripts completos para Reels",
      "Carrosséis prontos",
      "Slides com fotos reais",
      "Biblioteca e Kanban",
      "Calendário editorial",
      "Suporte por email",
    ],
  ...
  },
  {
    ...
    preco: "R$797",
    periodo: "/ano",
    desc: "O melhor custo-benefício — 2 meses grátis",
    recursos: [
      "60 gerações por mês",
      "Scripts completos para Reels",
      "Carrosséis prontos",
